...
function App() {
  const [splitPaneSize, setSplitPaneSize] = useState(
    parseInt(localStorage.getItem("splitPaneSize")) || 200
  );
useEffect(() => {
  localStorage.setItem("splitPaneSize", splitPaneSize.toString());
}, [splitPaneSize]);

const handleSplitPaneSizeChange = (newSize) => {
  setSplitPaneSize(newSize);
};
  return (
    <div className="App">
      <div className="plandiv my-4">
        <p>
